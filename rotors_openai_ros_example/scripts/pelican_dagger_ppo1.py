...
if __name__ == '__main__':
    rospy.init_node('pelican_ppo_motor_controller_dagger_training', anonymous=True, log_level=rospy.WARN)
    ...
    parser.add_argument('--exp_name', type=str, default='Pelican_motor_controller_dagger_for_ppo')
    ...
    for epoch in range(epochs):
        ...
        for t in range(episode_steps):
            ...
            ref_action = call_ref_controller(env, ref_controller)
        ...
        if epoch % trainning_policy_epochs == 0 and epoch > 0:
            ...
            for i in range(test_policy_epochs):
                ...
                for t in range(episode_steps):
                    ...
                    if done:
                        ...
                        policy_net.logger.store(AverageTestEpRet=policy_cumulated_reward)
            ...
            policy_net.logger.log_tabular('AverageTestEpRet', average_only=True)
            ...
            policy_net.save()
            # saver.save(session, os.path.join(PROJECT_ROOT, "model/model_ckpt"), global_step=epoch)
